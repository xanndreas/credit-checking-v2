...
$(function () {
    ...
    $('.datatable-Role tbody').on('click', 'td:not(:first-child, :last-child)', (event) => {
        ...
        $('select[name="permissions[]"]').val(row.permission_ids).trigger('change');

        let canvasSelector = document.getElementById('offcanvasAddRole')
        ...
        let bsOffCanvasAddRole = new bootstrap.Offcanvas(canvasSelector)
        bsOffCanvasAddRole.show();
    });
