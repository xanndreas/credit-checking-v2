<!-- Offcanvas to add -->
<div class="offcanvas offcanvas-end {{ $errors->any() ? 'show' : '' }}" tabindex="-1" id="offcanvasAddProduct"
     aria-labelledby="offcanvasAddProductLabel">
    <div class="offcanvas-header">
        <h5 id="offcanvasAddProductLabel" class="offcanvas-title">Product</h5>
    ...
    <div class="offcanvas-body mx-0 flex-grow-0 pt-0 h-100">
        <form class="add-new-product pt-0" id="addNewProductForm" method="POST"
            ...
            <div class="mb-3">
                <label for="aliases">{{ trans('cruds.product.fields.aliases') }}</label>
