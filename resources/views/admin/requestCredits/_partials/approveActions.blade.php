...
@can($approveGate)
    @if($requestApprovals->process_status_id == 2)
        <button type="button" class="btn btn-danger waves-effect btn-approvals" data-bs-toggle="modal" data-bs-target="#reasonModal">
            <i class="tf-icons ti ti-x"></i>
        </button>

        <button type="button" class="btn btn-success waves-effect btn-approvals" data-bs-toggle="modal" data-bs-target="#reasonApproveModal">
