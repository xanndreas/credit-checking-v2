<div class="modal fade text-start" id="reasonApproveModal" tabindex="-1" aria-labelledby="reasonApproveModal" aria-hidden="true"
     data-bs-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="reasonApproveModal">Please write Reasons</h4>
